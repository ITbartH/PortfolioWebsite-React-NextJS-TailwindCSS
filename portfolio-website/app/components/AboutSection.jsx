...
const AboutSection = ({ currentLang }) => { // Dodajemy destrukturyzację propsa
      ...
      <div className="md:grid md:grid-cols-2 gap-8 py-8 px-4 xl:gap-16 sm:py-16 xl:py-16">
        ...
        <div className="mt-16 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base md:text-lg">
            {currentLang === "EN" ? ENtranslation.aboutme.body : PLtranslation.aboutme.body}
          </p>
          <div className="flex flex-row justify-start mt-8">
            <TabButton selectTab={() => handleTabChange("skills")} active={tab === "skills"}>
              {currentLang === "EN" ? ENtranslation.aboutme.skills : PLtranslation.aboutme.skills}
            </TabButton>
            <TabButton selectTab={() => handleTabChange("education")} active={tab === "education"}>
              {currentLang === "EN" ? ENtranslation.aboutme.education : PLtranslation.aboutme.education}
            </TabButton>
            <TabButton selectTab={() => handleTabChange("certifications")} active={tab === "certifications"}>
              {currentLang === "EN" ? ENtranslation.aboutme.certifications : PLtranslation.aboutme.certifications}
            </TabButton>
          </div>
          <div id="podpunkty" className="mt-8 relative ">
